...
import com.furkansabuncu.javatravelbook.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //harita görünümü etkinleştirip ffragmen içine alalım
        ...
        sharedPreferences = MapsActivity.this.getSharedPreferences("com.furkansabuncu.travelbookjava",MODE_PRIVATE);
        trackBoolean = false;
